...
import Newmodal from '../../cityadmincomponents/pdatatable/NewModal'
...
const New = () => {
  return (
    ...
    <Link to="/cityadmin/publicplace"  onClick={<Newmodal />}> <div className="editButton  border rounded border-slate-300 p-1 hover:bg-blue-400 cursor-pointer">close</div>
          </Link>
