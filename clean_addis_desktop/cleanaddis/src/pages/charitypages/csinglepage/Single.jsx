...
import Modal from "../../../components/charitycomponents/cdatatable/Modal"
const Asingle = () => {
  return (
    <div>
      ...
      <div className="top flex">
        <div className="left shadow-2xl shadow-transparent p-10 relative flex ">
          ...
          <div className="details">
            <h1 className="itemname text-4xl m-5">Details About The Donation </h1>
            ...
            <Link to="/charity/donate"  onClick={<Modal />}> <div className="cursor-pointer border-2 w-32 h-10 items-center flex justify-center hover:bg-green-300">Request pickup</div>
           </Link>
            </div> 
